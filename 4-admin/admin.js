//localization
function localise() {
   var lan = localStorage.getItem("admin_lang");
   localization(lan);
}
...
function sign_out() {
  ...
  window.location = 'https://saurabhkumarr99.github.io/LiveQuiz/';
}

//fetching All Quiz from db.json
function AllQuiz() {
  var url = "https://saurabhkumarr99.github.io/database/db.json";
...
function AddQuiz(data) {
  fetch('https://saurabhkumarr99.github.io/database/quiz.json', {
    method: 'POST',
    headers: {
...
function DeleteQuiz(id) {
  fetch('https://saurabhkumarr99.github.io/database/quiz.json' + id, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
    },
...
function stud_respopnse(n, PrandonmNo) {
  var url = "https://saurabhkumarr99.github.io/database/Student_response.json";
